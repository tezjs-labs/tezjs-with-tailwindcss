...
<div class="container">
 <div class="relative bg-white overflow-hidden">
        ...
        <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
          <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
            <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
              <div class="flex items-center justify-between w-full md:w-auto">
                <a href="#">
                  ...
                  <img alt="Workflow" class="h-8 w-auto sm:h-10" src="../public/favicon.ico">
                </a>
            ...
            <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
              <tez-link to="/" class="font-medium text-gray-500 hover:text-gray-900">Home</tez-link>
      ...
      <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          <h1 class="text-4xl tracking-tight font-bold text-gray-900 sm:text-5xl sm:tracking-tight md:text-6xl md:tracking-tight">
            <span class="block xl:inline">Welcome to Tezjs </span>
          </h1> 
          <h2 class="text-2xl tracking-tight font-bold text-indigo-900 sm:text-5xl sm:tracking-tight md:text-6xl md:tracking-tight">make your website more faster</h2>
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="../assets/gallery.jpeg" alt="">
  </div>
</div>
</div>
 <footerComponent></footerComponent>
